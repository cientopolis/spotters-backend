...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { name: @level.name, required_points: @level.required_points } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { name: @level.name, required_points: @level.required_points } }
